...
datb <- dat[!(is.na(dat$culture_powerdistance)),] 
...
## Test multiple moderator model with all sig moderators
```{r}

multiplemoderator <- rma.mv(yi, vi, mods = ~ HighExp + LowExp + Subj + PerfPay, random =list(~ 1 | ID_2, ~ 1 | ID_1), tdist=TRUE, data=mlmdat)summary(multiplemoderator, digits=3)
