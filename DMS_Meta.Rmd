...
for (rho in rho_vec) {
  ...
  m[[2]] <- robust(m[[2]], cluster = study_id_1, clubSandwich = TRUE)
   ...
   ## Sample type metric as moderator----------------------------------------------------
  ## No reference level
  m[[3]] <- rma.mv(yi ~ 0 + sample_type,
                   V = V_mat,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=dat,
                   digits=4)
  ...
  m[[4]] <- rma.mv(yi ~ 1 + prop_female_gen,
                   V = V_mat,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=dat,
                   digits=4)
  ...
  V_matb <- vcalc(vi = vi,
   ...
   m[[5]] <- rma.mv(yi ~ 1 + culture_powerdistance,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[6]] <- rma.mv(yi ~ 1 + culture_individualism,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[8]] <- rma.mv(yi ~ 1 + culture_uncertaintyavoidance,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[9]] <- rma.mv(yi ~ 1 + culture_longtermorientation,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[10]] <- rma.mv(yi ~ 1 + culture_indulgence,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
