...
### UPDATE TO HAVE CODE FOR EACH LEVEL OF CONTEXT ###
contexts <- c("Military tactical planning", "Risky driving", "Smartphone use ",
              "Stressful situations", "Workplace email use")
...
forest.rma(oneES1, annotate=F, slab = OneES_data$first_author, addfit = T, 
           order = "obs", xlab = NA, alim= c(-0.50,1.5), xintercept=0,
           xlim =c(0,1.15), cex = .5, cex.lab = c(0,1), ylim = c(0,135), 
           refline = NA)
