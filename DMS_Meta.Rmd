...
# EFFECT SIZES ----------------------------------------------------------
  ...
  smd_dat_av <- df1 %>% 
    ...
    smd_dat_av <- escalc(measure = "RPB",
                    m1i = c(young_adults_avoidance_mean,adolescents_younger_avoidance_mean), 
                    m2i = c(young_adults_avoidance_sd,adolescents_younger_avoidance_sd),
                    sd1i = c(older_adults_avoidance_mean,adolescents_older_avoidance_mean),
                    sd2i = c(older_adults_avoidance_sd,adolescents_older_avoidance_sd),
  ...
  cor_dat_av <- escalc(measure = 'COR',
                    ri = c(avoidance_age_result,age_avoidance_group_1_result,
  ...
  cor_dat_dp <- escalc(measure = 'COR',
                    ri = c(dependent_age_result,female_age_dependence_result,
