...
for (rho in rho_vec) {
  ...
  dat <- dat %>% 
    ...
    mutate(prop_female_gen = 
             case_when(is.na(gender_female_value) & !is.na(young_prop_female) & !is.na(old_prop_female) ~
                         ((young_total_n/n_incl_es)*young_prop_female)+((old_total_n/n_incl_es)*old_prop_female),
  ...
  V_matb <- vcalc(vi = vi,
   ...
   m[[4]] <- rma.mv(yi ~ 0 + culture_powerdistance,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[5]] <- rma.mv(yi ~ 0 + culture_individualism,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[7]] <- rma.mv(yi ~ 0 + culture_uncertaintyavoidance,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[8]] <- rma.mv(yi ~ 0 + culture_longtermorientation,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  m[[9]] <- rma.mv(yi ~ 0 + culture_indulgence,
                   V = V_matb,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=datb,
                   digits=4)
  ...
  ## Participant sample as moderator-----------------------------------------------------
  m[[11]] <- rma.mv(yi ~ 0 + sample_type,
                   V = V_mat,
                   random = ~ 1 | study_id_1/es_id, # random effect of study and estimate
                   data=dat,
                   digits=4)
